import svgPaths from "./svg-4mofajkgqn";
    ...
    <div className="absolute h-[57px] left-[286px] top-[789px] w-[92px]">
      <div className="absolute inset-[-7.02%_-13.04%_-21.05%_-4.35%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 108 73">
          <g id="Group 1">
            <g filter="url(#filter0_d_2_702)" id="Rectangle 3">
          ...
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="73" id="filter0_d_2_702" width="108" x="0" y="0">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_2_702" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_2_702" mode="normal" result="shape" />
            </filter>
          </defs>
        </svg>
      </div>
...
export default function AboutTheProject() {
  return (
    <div className="bg-[#ab4d4d] relative size-full" data-name="About the Project 4">
      ...
      <Group />
      <div className="absolute left-[203px] size-[19px] top-[714px]">
      ...
      <div className="absolute bg-[#6d3232] h-[19px] left-[142px] rounded-[8px] top-[714px] w-[43px]" />
      ...
      <p className="-translate-x-1/2 absolute font-['Luckiest_Guy:Regular',sans-serif] h-[100px] leading-[normal] left-[203px] not-italic text-[28px] text-center text-shadow-[4px_4px_4px_rgba(0,0,0,0.5)] text-white top-[557px] w-[354px]">Já pensou em tirar suas dúvidas diretamente com os maiores gênios da história?</p>
    </div>
  );
}